...
struct sysent sysent[] = {
	...
	{ AS(__proc_info_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 258 = __proc_info */
	{ AS(__iopolicysys_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 259 = __iopolicysys */
	...
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 281 = audit_session_self */
	{ AS(audit_session_join_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 282 = audit_session_join */
	{ AS(audit_session_port_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 283 = audit_session_port */
	...
	{ AS(kevent64_args), (sy_call_t *)sys_kevent64, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 370 = kevent64 */
	...
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 627 = mach_thread_self_trap */
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 628 = mach_task_self_trap */
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 629 = mach_host_self_trap */
	...
	{ AS(mach_semaphore_signal_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 633 = mach_semaphore_signal_trap */
	{ AS(mach_semaphore_signal_all_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 634 = mach_semaphore_signal_all_trap */
	{ AS(mach_semaphore_signal_thread_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 635 = mach_semaphore_signal_thread_trap */
	{ AS(mach_semaphore_wait_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 636 = mach_semaphore_wait_trap */
	{ AS(mach_semaphore_wait_signal_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 637 = mach_semaphore_wait_signal_trap */
	{ AS(mach_semaphore_timedwait_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 638 = mach_semaphore_timedwait_trap */
	{ AS(mach_semaphore_timedwait_signal_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 639 = mach_semaphore_timedwait_signal_trap */
	...
	{ AS(mach_task_name_for_pid_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 644 = mach_task_name_for_pid */
	{ AS(mach_task_for_pid_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 645 = mach_task_for_pid */
	{ AS(mach_pid_for_task_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 646 = mach_pid_for_task */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 647 = nosys */
	{ AS(mach_macx_swapon_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 648 = mach_macx_swapon */
	{ AS(mach_macx_swapoff_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 649 = mach_macx_swapoff */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 650 = nosys */
	{ AS(mach_macx_triggers_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 651 = mach_macx_triggers */
	{ AS(mach_macx_backing_store_suspend_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 652 = mach_macx_backing_store_suspend */
	{ AS(mach_macx_backing_store_recovery_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 653 = mach_macx_backing_store_recovery */
	...
	{ AS(mach_swtch_pri_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 659 = mach_swtch_pri */
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 660 = mach_swtch */
	{ AS(mach_thread_switch_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 661 = mach_thread_switch */
	{ AS(mach_clock_sleep_trap_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 662 = mach_clock_sleep_trap */
