...
const char *syscallnames[] = {
	...
	"mach_thread_self_trap",			/* 627 = mach_thread_self_trap */
	"mach_task_self_trap",			/* 628 = mach_task_self_trap */
	"mach_host_self_trap",			/* 629 = mach_host_self_trap */
	"#630",			/* 630 = nosys */
	"mach_msg_trap",			/* 631 = mach_msg_trap */
	"mach_msg_overwrite_trap",			/* 632 = mach_msg_overwrite_trap */
	"mach_semaphore_signal_trap",			/* 633 = mach_semaphore_signal_trap */
	"mach_semaphore_signal_all_trap",			/* 634 = mach_semaphore_signal_all_trap */
	"mach_semaphore_signal_thread_trap",			/* 635 = mach_semaphore_signal_thread_trap */
	"mach_semaphore_wait_trap",			/* 636 = mach_semaphore_wait_trap */
	"mach_semaphore_wait_signal_trap",			/* 637 = mach_semaphore_wait_signal_trap */
	"mach_semaphore_timedwait_trap",			/* 638 = mach_semaphore_timedwait_trap */
	"mach_semaphore_timedwait_signal_trap",			/* 639 = mach_semaphore_timedwait_signal_trap */
	"#640",			/* 640 = nosys */
	...
	"obs_{",			/* 643 = obsolete { */
	"mach_task_name_for_pid",			/* 644 = mach_task_name_for_pid */
	"mach_task_for_pid",			/* 645 = mach_task_for_pid */
	"mach_pid_for_task",			/* 646 = mach_pid_for_task */
	"#647",			/* 647 = nosys */
	"mach_macx_swapon",			/* 648 = mach_macx_swapon */
	"mach_macx_swapoff",			/* 649 = mach_macx_swapoff */
	"#650",			/* 650 = nosys */
	"mach_macx_triggers",			/* 651 = mach_macx_triggers */
	"mach_macx_backing_store_suspend",			/* 652 = mach_macx_backing_store_suspend */
	"mach_macx_backing_store_recovery",			/* 653 = mach_macx_backing_store_recovery */
	"#654",			/* 654 = nosys */
	"#655",			/* 655 = nosys */
	"#656",			/* 656 = nosys */
	"#657",			/* 657 = nosys */
	"#658",			/* 658 = nosys */
	"mach_swtch_pri",			/* 659 = mach_swtch_pri */
	"mach_swtch",			/* 660 = mach_swtch */
	"mach_thread_switch",			/* 661 = mach_thread_switch */
	"mach_clock_sleep_trap",			/* 662 = mach_clock_sleep_trap */
	"#663",			/* 663 = nosys */
	"#664",			/* 664 = nosys */
	"#665",			/* 665 = nosys */
	"#666",			/* 666 = nosys */
